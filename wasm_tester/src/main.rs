...
impl FunctionConfig {
    fn filter_params(&self, params: &HashMap<String, serde_json::Value>) -> HashMap<String, serde_json::Value> {
...
pub fn execute_wasm_function(
    ...
    let return_values: &ReturnValues = unsafe {
        &*(memory_slice.as_ptr() as *const ReturnValues)
    };
